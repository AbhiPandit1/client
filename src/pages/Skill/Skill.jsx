    ...
    <div className=" text-left pt-10  h-full sm:mt-0 ">
      ...
      <div className="flex flex-col h-full gap-[10rem] p-8 ">
        ...
        <div className="grid grid-cols-1  sm:flex sm:gap-[20rem]">
          ...
          <div className="grid grid-cols-2 gap-20 sm:grid sm:grid-cols-3 sm:gap-12 pt-8">
            {skills
              .filter((skill) => skill.type === 'Frontend')
              .map((front) => (
                <div key={front.id} className="flex items-center ">
                  {front.image}
                  <span className="ml-2 text-3xl">{front.label}</span>
                </div>
              ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:flex sm:gap-[20rem]">
          ...
          <div className="grid grid-cols-2 sm:grid sm:grid-cols-3 gap-20 pt-8">
            {skills
